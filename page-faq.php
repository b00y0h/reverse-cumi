...
$faq_style = rwmb_meta('gg_faq_page_style');
...
if ($faq_style == 'sidebar') { st_before_content($columns=''); } else { st_before_content($columns='twelve'); }
...
st_after_content();
if ($faq_style == 'sidebar') {get_sidebar('page');}
?>
